...
export class ServerService {
	...
	public isMobile() { return this._isMobile; }
	...
	constructor(
		...
		if (this.req.cookies && this.req.cookies[JWT.COOKIE_REFRESH]) {
			this.tokenService.refreshToken = this.req.cookies[JWT.COOKIE_REFRESH];
		}
